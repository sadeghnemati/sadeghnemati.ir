...
var files = (function () {
    ...
    Singleton.defaultOptions["github.txt"] = "https://github.com/sadeghnemati/";
    ...
    Singleton.defaultOptions["Back_to_Home.txt"] = "https://sadeghnemati/";
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
            return instance;
